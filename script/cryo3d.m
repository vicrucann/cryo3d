...
cellparams = {'pathout';'pathdata';'caching';'pathcache';'dtheta';'maskfile';'maxmem';'numthreads';'rotstep';'transmax';...
    ...
    't';'numruns';'maxnumiter';'convtol';'normprojint';...
...
configfile = generate_config(pathout, imfile, eval(ctffile), str2num(substep), str2num(reconhalf), str2num(reconstartind), ...
    structfile, coordfile, eval(maskfile), str2num(pf), str2num(pixfromedge), str2num(maxmem), str2num(numthreads), str2num(dispflag),...
    str2num(t), str2num(numruns), str2num(maxnumiter), str2num(convtol), str2num(normprojint), str2num(rotstart), str2num(rotstep), ...
