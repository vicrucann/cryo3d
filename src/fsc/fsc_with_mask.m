...
%           pixfromedge = Number of pixels from edge of image for hard mask
%           maskwidth = Width of the soft mask edge in pixels
% Outputs:
...
function [fsc,f_ind,mask3d] = fsc_with_mask(m1,m2,voxel_size,tick_spacing,pixfromedge,maskwidth)
...
mask = get_mask_struct_ncd([n,n,n],pixfromedge);
sigma = maskwidth/2/3;
gsize = maskwidth;
if mod(gsize,2) == 0
    gsize = gsize + 1;
end
mask3d = smooth3(mask.bin,'gaussian',[gsize,gsize,gsize],sigma);
